...
fn fft_row_main(
    ...
    let rev_t  = bit_reverse(t,        8u);
    let rev_t2 = bit_reverse(t + 32u,  8u);
    let rev_t3 = bit_reverse(t + 64u,  8u);
    let rev_t4 = bit_reverse(t + 96u,  8u);
    let rev_t5 = bit_reverse(t + 128u, 8u);
    let rev_t6 = bit_reverse(t + 160u, 8u);
    let rev_t7 = bit_reverse(t + 192u, 8u);
    let rev_t8 = bit_reverse(t + 224u, 8u);
